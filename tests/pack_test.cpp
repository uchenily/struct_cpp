...
TEST_CASE("pack sanity", "[cppystruct::pack]") {
    ...
    REQUIRE_STATIC(pystruct::pack(PY_STRING(">ci"), '*', 0x12131415)
                   == "*\x12\x13\x14\x15"sv);
    REQUIRE(pystruct::pack(PY_STRING(">bfi"), true, 0.5f, 1)
            == "\x01?\x00\x00\x00\x00\x00\x00\x01"sv);
    REQUIRE(pystruct::pack(PY_STRING(">bdi"), true, 0.5, -1)
...
TEST_CASE("pack string", "[cppystruct::pack]") {
    ...
    REQUIRE_STATIC(pystruct::pack(PY_STRING("<h5s"), 126, "12345")
                   == "\x7e\x00"
                      "12345"sv);
    REQUIRE_STATIC(pystruct::pack(PY_STRING(">h5s"), 126, "12345")
                   == "\x00\x7e"
    ...
    REQUIRE_STATIC(pystruct::pack(PY_STRING("<2c3s2H"),
                                  'x',
                                  'y',
                                  "zwt  __",
                                  0x1234,
