...
constexpr bool operator==(const std::array<char, ArrSize> &arr,
                          std::string_view                 str) {
...
constexpr bool operator==(const std::pair<F, S>   &lhs,
                          const std::pair<F2, S2> &rhs) {
...
constexpr bool equals(const std::tuple<Lhs...> &lhs,
                      const std::tuple<Rhs...> &rhs,
